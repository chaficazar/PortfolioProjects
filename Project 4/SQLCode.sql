...
ORDER BY AwardYear, Industry, ProjectValue DESC
...
-- Query 11
-- Looking at overall project count and project values over the years
...
-- Query 29
-- Using the above query, finding the projects that are currently marked as 'Design' and 'Study' in Kuwait for business development reasons
...
-- Query 35
-- Finding if any of the contractors identified in Query X above have similar experience with requirements of upcoming projects
